...
export const AboutUs = () => {
  ...
  <>
    <div className="model-container">
      <ModelView modelPath='/assets/gltf/assembly_2021/full_assembly_2021.gltf'/>
    ...
    <div className="model-container">
      <ModelView modelPath='/assets/gltf/assembly_2023/frame_assembly_26-05-23.gltf'/>
      <div className="model-description">
    ...
    <div className="model-container">
      <ModelView modelPath='/assets/gltf/assembly_2024/full_assembly_2024.gltf'/>
      <div className="model-description">
